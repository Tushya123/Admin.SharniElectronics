...
import {
  ...
  removeProductDetail,
  updateProductDetail,
} from "../../functions/Services/ServiceDetail";
...
const ServiceDetail = () => {
    ...
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/list/servicetype`
        );
  ...
  const handleCheckTP = (e) => {
    ...
    //   setvalues({
    //     ...values,
    //     ServiceDetail: "Select Product Group",
  ...
  const validate = (values) => {
    ...
    if (values.Description === "") {
      errors.Description = "Service Name is required";
      setErrPN(true);
    }
    ...
    if (values.ProductDescription === "") {
      errors.ProductDescription = "Service Description  is required";
      setErrPD(true);
    }
    ...
    if (values.ProductPrice === "") {
      errors.ProductPrice = "Service Price is required";
      setErrPP(true);
    }
    ...
    if (
      ...
      errors.ProductHoverImage = "Service Hover Image is required";
    ...
    if (values.ServiceDetail === "") {
      errors.ServiceDetail = "Service Group is required";
      setErrHI(true);
    } else if (values.ServiceDetail === "Select Service Group") {
      errors.ServiceDetail = "Service Group is required";
      setErrHI(true);
    }
  ...
  const columns = [
    ...
    {
      name: "Service Group",
      selector: (row) => row.ServiceDetailTypes[0].ServiceGroup,
      sortable: true,
      sortField: "categ",
      minWidth: "150px",
    },
  ...
  const fetchlayouts = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/listservicedetailbyparam`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
  ...
  document.title = "Service Details | Shreeji Pharma";
                                ...
                                <Row>
                                  <Col md={6}>
                                    <div className="form-floating mb-3">
                                      ...
                                      {isSubmit && formErrors.ServiceDetail && (
                                        <p className="text-danger">
                                          {formErrors.ServiceDetail}
                                        </p>
                                      )}
                                    </div>
                                  </Col>
