...
} from "../../functions/Services/ServiceGroup";
...
const ServiceGroup = () => {
  ...
  const { IsActive,ImageUrl,ServiceGroup} =
    values;
  ...
  const handleClick = (e) => {
    ...
    if (Object.keys(erros).length === 0) {
      ...
      formdata.append("ServiceGroup", values.ServiceGroup);
  ...
  document.title = "Service Group | Sharni Electronics" ;

  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb    maintitle="Service Group"
            title="Service Group"
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Service Group</h2>
                    </Col>
        ...
        <form>
          <ModalBody>
            <div className="form-floating mb-3">
              ...
              />
              <Label>
              Service Group <span className="text-danger">*</span>
              </Label>
              {isSubmit && (
            ...
            <Col lg={6}>
              <label>
              Service Group Image <span className="text-danger">*</span>
              </label>
        ...
        <form>
          <ModalBody>
            <div className="form-floating mb-3">
              ...
              {isSubmit && (
                <p className="text-danger">{formErrors.ServiceGroup}</p>
              )}
            </div>
            {/* <div className="form-floating mb-3">
              <Input
