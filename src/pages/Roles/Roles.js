...
const CmsMaster = () => {
              ...
              uploadproductImage(body)
                .then((res) => {
                  ...
                  resolve({
                    ...
                    default: `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/uploads/rolesCKImage/${res.url}`,
  ...
  const fetchCategories = async () => {
    ...
    await axios
      ...
      .post(`${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/list-by-params/role`, {
