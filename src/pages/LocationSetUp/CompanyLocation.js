...
const CompanyLocation = () => {
  ...
  const fetchData = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/list-by-params/company-locations`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
                ...
                <img
                  ...
                  src={
                    newProfileImageSelected
                      ? image
                      : `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/${values.StoreLogo}`
                  }
                  width="180"
                  height="180"
                />
