...
export const listSupplierQuote = async () => {
    return await axios.get(`${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/list/supplierquote`);
};

export const createSupplierQuote = async (values) => {
    return await axios.post(`${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/create/supplierquote`, values);
};

export const updateSupplierQuote = async (_id, values) => {
  return await axios.put(`${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/update/supplierquote/${_id}`, values);
};
