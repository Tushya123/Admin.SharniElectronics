...
export const createProductGroup = async (values) => {
  try{
    ...
    const response =await axios.post(
      `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/servicetype`,
      values
    )
...
export const removeProductGroup = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/remove/servicetype/${_id}`
  );
};
...
export const updateProductGroup = async (_id, values) => {
  return await axios.put(
    `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/update/servicetype/${_id}`,
    values
  );
};
...
export const getProductGroup = async (_id) => {
  return await axios.get(
    `${process.env.REACT_APP_API_URL_SHARNI_ELECTRONICS}/api/auth/get/servicetype/${_id}`
  );
};
